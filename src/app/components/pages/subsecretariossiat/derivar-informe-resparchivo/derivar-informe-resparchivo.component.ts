...
@Component({
  selector: 'app-derivar-informe-resparchivo',
  templateUrl: './derivar-informe-resparchivo.component.html',
  styleUrls: ['./derivar-informe-resparchivo.component.scss']
})
export class DerivarInformeResparchivoComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<DerivarInformeResparchivoComponent>,
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
               ...
               // console.log(params);
                ...
                this._derivacionrenacservice.apiDerivacionRenacDerivarInformesParaAnotacionSubsecretarioSsiatPut$Json(params).subscribe({
