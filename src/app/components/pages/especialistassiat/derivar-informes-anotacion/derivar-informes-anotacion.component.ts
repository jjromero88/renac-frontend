...
@Component({
  selector: 'app-derivar-informes-anotacion',
  templateUrl: './derivar-informes-anotacion.component.html',
  styleUrls: ['./derivar-informes-anotacion.component.scss']
})
export class DerivarInformesAnotacionComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<DerivarInformesAnotacionComponent>,
  ...
  ngOnInit() { 
    ...
    console.log(this.informesRenacSelected);
  ...
  onFormSubmit() {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this._derivacionrenacservice.apiDerivacionRenacDerivarInformesParaAnotacionEspecialistaSsiatPut$Json(params).subscribe({
